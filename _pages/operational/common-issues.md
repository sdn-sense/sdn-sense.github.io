...
Since SiteRM 1.6.3, most service states reported here also carry a stable numeric `exccode` — see the [Error Code Reference](/operational/error-codes/) for the full list and what each one means.
