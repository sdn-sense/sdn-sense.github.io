...
# SiteRM-Debugger Installation First time (Docker)
...
# SiteRM-Debugger Upgrade (Using Docker)
...
* To install node_exporter on bare metal, please follow official documentation here: [https://prometheus.io/docs/guides/node-exporter/](https://prometheus.io/docs/guides/node-exporter/)
  * Please make sure that it uses `--path.rootfs=/host` and `--collector.netdev.address-info` flags for node_exporter for bare metal installation.
* In case you dont want to install it on a bare metal machine, you can run node_exporter inside Docker:
  * **DOCKER** - example here: [https://github.com/sdn-sense/siterm-startup/tree/master/node-exporter/docker](https://github.com/sdn-sense/siterm-startup/tree/master/node-exporter/docker)
